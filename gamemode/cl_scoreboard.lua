...
local PLAYER_LINE = 
{
	...
	Paint = function( self, w, h )
		...
		if ( self.Player:Team() == 2 ) then
			draw.RoundedBox( 4, 0, 0, w, h, Color( 0, 0, 255, 200 ) )
			return
		end
		
		if ( self.Player:Team() == 3 ) then
			draw.RoundedBox( 4, 0, 0, w, h, Color( 0, 255, 0, 200 ) )
			return
		end
		
		if ( self.Player:Team() == 4 ) then
			draw.RoundedBox( 4, 0, 0, w, h, Color( 255, 255, 0, 200 ) )
			return
		end
...
local SCORE_BOARD = 
{
	...
	Paint = function( self, w, h )
		...
		surface.DrawTexturedRect( 550, 65, 32, 32 )
